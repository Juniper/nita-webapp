...
;(function ($, window) {
  ...
  (function (p) {
      ...
      p.setFixedContainerWidth = function () {
        ...
        stc.$fixedContainer.width(stc.fixedContainerWidth = stc.$tabsContainer.outerWidth() - 10);
      };
      ...
      p.setFixedContainerWidthForJustHiddenScrollArrows = function () {
        ...
        stc.$fixedContainer.width(stc.fixedContainerWidth -5 );
      };
      ...
      p.setFixedContainerWidthForJustVisibleScrollArrows = function () {
        ...
        stc.$fixedContainer.width(stc.fixedContainerWidth - stc.scrollArrowsCombinedWidth -5);
      };
  ...
  var tabElements = (function () {
    ...
    function getNewElScrollerElementWrappingNavTabsInstance($navTabsInstance) {
      var $tabsContainer = $('<div class="scrtabs-tab-container"></div>'),
          $leftArrow = $('<div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-left"><span class="fa fa-angle-left fa-lg"></span></div>'),
          $rightArrow = $('<div class="scrtabs-tab-scroll-arrow scrtabs-js-tab-scroll-arrow-right" style="padding-left:6px"><span class="fa fa-angle-right fa-lg"></span></div>'),
