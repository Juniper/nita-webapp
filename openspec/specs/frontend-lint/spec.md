...
## Purpose
CI enforcement of the React/TypeScript SPA's ESLint configuration so lint
regressions cannot merge silently, and a guarantee that the `frontend/` source
stays free of ESLint errors.
